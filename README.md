...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/xtensor-blas-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/xtensor-blas-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/xtensor-blas-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/xtensor-blas-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/xtensor-blas-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/xtensor-blas-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/xtensor-blas/badges/version.svg)](https://anaconda.org/conda-forge/xtensor-blas)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/xtensor-blas/badges/downloads.svg)](https://anaconda.org/conda-forge/xtensor-blas)
